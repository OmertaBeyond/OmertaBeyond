...
// @icon			https://raw.github.com/OmertaBeyond/OmertaBeyond/master/images/logo.small.png
// @screenshot			https://raw.github.com/OmertaBeyond/OmertaBeyond/master/images/sshot.png https://raw.github.com/OmertaBeyond/OmertaBeyond/master/images/sshot_tn.png
...
// @encoding			UTF-8
// @priority			1
// @require			https://raw.github.com/OmertaBeyond/OmertaBeyond/master/scripts/libs.js
// @require			https://raw.github.com/OmertaBeyond/OmertaBeyond/master/scripts/settings.js
// @require			https://raw.github.com/OmertaBeyond/OmertaBeyond/master/scripts/langs.js
// @resource			css		https://raw.github.com/OmertaBeyond/OmertaBeyond/master/scripts/beyond.css
// @resource			trash		https://raw.github.com/OmertaBeyond/OmertaBeyond/master/images/del.png
// @resource			colorpicker	https://raw.github.com/OmertaBeyond/OmertaBeyond/master/images/colorpicker.gif
...
// @resource			buttonMenu	https://raw.github.com/OmertaBeyond/OmertaBeyond/master/images/menu.png
// @resource			buttonReset	https://raw.github.com/OmertaBeyond/OmertaBeyond/master/images/reset.png
// @resource			favoriteIco	https://raw.github.com/OmertaBeyond/OmertaBeyond/master/images/favicon.png
// @resource			edoIco		https://raw.github.com/OmertaBeyond/OmertaBeyond/master/images/edo.png
// @resource			updateIco	https://raw.github.com/OmertaBeyond/OmertaBeyond/master/images/updateicon.png
// @resource			brcGear		https://raw.github.com/OmertaBeyond/OmertaBeyond/master/images/brcgear.png
// @resource			deleteIcon	https://raw.github.com/OmertaBeyond/OmertaBeyond/master/images/deleteicon.png
// @resource			reply		https://raw.github.com/OmertaBeyond/OmertaBeyond/master/images/reply.png
// @resource			loading		https://raw.github.com/OmertaBeyond/OmertaBeyond/master/images/loading.png
// @resource			nickreader	https://raw.github.com/OmertaBeyond/OmertaBeyond/master/images/magnifier.png
// @resource			nextIcon	https://raw.github.com/OmertaBeyond/OmertaBeyond/master/images/next.png
// @resource			prevIcon	https://raw.github.com/OmertaBeyond/OmertaBeyond/master/images/prev.png
// @resource			check		https://raw.github.com/OmertaBeyond/OmertaBeyond/master/images/check.png
// @resource			changelog	https://raw.github.com/OmertaBeyond/OmertaBeyond/master/images/changelog.png
...
if (urlsearch == '/BeO/webroot/index.php?module=Crimes_ac&action=docrime') {
	...
	if (db.textContent.indexOf(sets.crimetracker[0]) != -1) {
		var rex1 = new RegExp(sets.crimetracker[1]);
	...
	function garageCrusher() {
		...
		if(ls.length > 1){
			if(ls.indexOf('heist') != -1 || ls.indexOf('nodam') != -1 || ls.indexOf('max') != -1 || ls.indexOf('oc') != -1){
				...
				for(i=2;i<rows-2;i++){
					y = (prefs[24])?'//form/center/table/tbody/tr['+(i+2)+']/td[3]/a':'//form/center/table/tbody/tr['+(i+2)+']/td[2]/a';//get car
					car = $X(y).href.match(/\d+/g)[0];
					z = (prefs[24])?'//form/center/table/tbody/tr['+(i+2)+']/td[4]':'//form/center/table/tbody/tr['+(i+2)+']/td[3]';//get percentage damage
					perc = $I(z);
					...
					if(stop == 0){
						...
						if((tr < max && select==1)||(tr > max && select==0)){
							var p = (prefs[24])?7:6;
							$X('//form/center/table/tbody/tr['+(i+2)+']/td['+p+']/input[2]').checked = true;
						}
					}
				}
			}
...
if (dlp.indexOf('allusers.php') != -1) {
	var page = GetParam('start');
	page = (page/15)+1;
	var pagenum = cEL('p');
	pagenum.innerHTML = 'Page: '+page;
	$X('//h4').parentNode.insertBefore(pagenum, $X('//center').nextSibling);
}
