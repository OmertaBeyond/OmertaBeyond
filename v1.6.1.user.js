...
// @description    Omerta Beyond 1.6.1 (The greatest addon for Omerta available!)
					...
					for(i=0;i<=3;i++) { //loop sms menu prefs
						...
						if(buttonpref[k].slice(i,h) == "0") { del("//div[@id='sms']/table/tbody/tr["+j+"]") }
							...
							if(GM_getValue('keypref1')) { if(keypref[k].slice(i,h) != "*") { 
								...
								xpath("//div[@id='sms']/table/tbody/tr["+j+"]/td/a").snapshotItem(0).innerHTML = xpath("//div[@id='sms']/table/tbody/tr["+j+"]/td/a").snapshotItem(0).innerHTML + " (" + keypref[k].slice(i,h).toUpperCase() + ")"; }
							}
								...
								if(keypref[k].slice(i,h) != "*") { 
									if(k==5) { //family menu
										if(i<fambuttons) { //check saved fampos with current fampos in the menu
											...
											xpath("//div[@id='"+menunames[k]+"']/table/tbody/tr["+j+"]/td/a").snapshotItem(0).innerHTML = xpath("//div[@id='"+menunames[k]+"']/table/tbody/tr["+j+"]/td/a").snapshotItem(0).innerHTML + " (" + keypref[k].slice(i,h).toUpperCase() + ")";
										}
									}
									else { 
										xpath("//div[@id='"+menunames[k]+"']/table/tbody/tr["+j+"]/td/a").snapshotItem(0).accessKey = keypref[k].slice(i,h);
...
if(prefs[21] && dlp == '/obay.php' && xpath('/html/body').snapshotItem(0).innerHTML.indexOf('<table') != -1)
	...
	else if(xpath('/html/body').snapshotItem(0).innerHTML.indexOf('Pack of bullets') != -1) {
...
if(dlp == '/messages.php' && (dls == '' || dls.indexOf('action=delete') !=-1) && prefs[22]) {
