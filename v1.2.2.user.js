...
//load any GET querys
var querys = ['menu_faminfo','menu_history','menu_deaths','menu_honoured','menu_randomquote','menu_cocaine','familys','colours','jailint','priority','newsammount','custombg','comments','bold','high','low','colour','refresh'];
//description for custom beyond menu
var descr = ["Family Info","User History","Deaths List","Most Honoured","Random Quote","Cocaine Prices"];
//links for custom beyond menu
var qlinks = ['http://www.igbots.com/omerta.php?familys','http://www.igbots.com/omerta.php?history','http://www.igbots.com/omerta.php?deaths','http://www.igbots.com/omerta.php?honour','http://www.igbots.com/omerta.php?randomquote','http://www.igbots.com/omerta.php?prices'];
...
if(document.location.pathname == '/pic.php') {
	...
	document.getElementsByTagName('IMG')[0].src = pic;
}