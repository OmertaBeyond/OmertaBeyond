...
var querys = ['menu_faminfo','menu_history','menu_deaths','menu_honoured','menu_randomquote','menu_cocaine','menu_news','familys','colours','jailint','priority','newsammount','custombg','comments','bold','high','low','colour','refresh']; //load any GET querys
var descr = ["Family Info","User History","Deaths List","Most Honoured","Random Quote","Cocaine Prices","Fingons News"]; //description for custom beyond menu
